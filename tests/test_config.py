...
def test_load_settings_reads_project_env_file(tmp_path, monkeypatch):
    for name in [
        ...
        "PROCESSING_ALERTS_MIN_VALID_JOINTS",
        "PROCESSING_ALERTS_MAX_REPROJ_ERROR_PX",
        "PROCESSING_ALERTS_PREDICT_SECONDS",
        "PROCESSING_ALERTS_SMOOTH_ALPHA",
        "PROCESSING_ALERTS_COOLDOWN_SEC",
    ...
    env_path.write_text(
        "\n".join(
            [
                ...
                "PROCESSING_ALERTS_DANGER_POINTS_JSON=runtime/alerts/danger_points.json",
                "PROCESSING_ALERTS_MIN_VALID_JOINTS=10",
                "PROCESSING_ALERTS_MAX_REPROJ_ERROR_PX=55.5",
                "PROCESSING_ALERTS_PREDICT_SECONDS=1.5",
                "PROCESSING_ALERTS_SMOOTH_ALPHA=0.45",
                "PROCESSING_ALERTS_COOLDOWN_SEC=2.0",
                "PROCESSING_ALERTS_APPROACH_WARNING_RADIUS_M=0.9",
                "PROCESSING_ALERTS_APPROACH_DANGER_RADIUS_M=0.4",
                "PROCESSING_ALERTS_COLLISION_WARNING_RADIUS_M=0.3",
            ]
        ),
        encoding="utf-8",
    )
    ...
    assert settings == Settings(
        ...
        alerts_ttl_ms=750,
        alerts_danger_points_json=Path("runtime/alerts/danger_points.json"),
        alerts_min_valid_joints=10,
        alerts_max_reproj_error_px=55.5,
        alerts_predict_seconds=1.5,
        alerts_smooth_alpha=0.45,
        alerts_cooldown_sec=2.0,
        alerts_approach_warning_radius_m=0.9,
        alerts_approach_danger_radius_m=0.4,
        alerts_collision_warning_radius_m=0.3,
    )
